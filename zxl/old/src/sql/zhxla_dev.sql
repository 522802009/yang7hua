...
--
-- Host: localhost
-- Generation Time: 2014-06-20 14:08:07
-- 服务器版本： 5.6.19
-- PHP Version: 5.4.26
...
CREATE TABLE IF NOT EXISTS `log` (
  ...
  `mid` smallint(6) NOT NULL DEFAULT '0' COMMENT '会员ID',
...
INSERT INTO `log` (`logid`, `mid`, `reason`, `realname`, `idcard`, `addtime`) VALUES
(1, 1, '贷款审批', '杨华', '420528198709081396', 1403150012),
(2, 1, '担保资格审批', '杨华', '420528198709081396', 1403150024),
(3, 1, '担保资格审批', '杨华', '420528198709081396', 1403150050);
